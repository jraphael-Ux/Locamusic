...
customElements.define('va-app-header', class AppHeader extends LitElement {
  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <a href="/addHouse" @click="${anchorRoute}">Add House</a>
      `: html ``}
    ...
    <a href="/" @click="${this.menuClick}"><img class="app-side-menu-logo" src="/images/logo.svg"></a>
      <nav class="app-side-menu-items">
        <a href="/profile" @click="${this.menuClick}">Profile</a>
        ${this.user.accessLevel == 1 ? html `
      <a href="/addHouse" @click="${this.menuClick}">Add House</a>
      `: html ``}
        <a href="/bunky" @click="${this.menuClick}">Find a Bunky</a>
