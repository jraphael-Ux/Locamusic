...
class Auth {
  ...
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      // new user! redirected newUser to guide page (/guide)
...
class UserAPI {
  ...
  async getUser(userId) {
    ...
    if (!response.ok) {
      //console log error
      const err = await response.json();
      if (err) console.log(err); // throw error (exit this fucntion)
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"BunkyAPI.js":[function(require,module,exports) {
"use strict";
...
class BunkyAPI {
  async addHouse(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/addHouse"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
  ...
  async getBunky() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/bunky"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
var _default = new BunkyAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/addHouse.js":[function(require,module,exports) {
"use strict";
...
var _BunkyAPI = _interopRequireDefault(require("./../../BunkyAPI"));
...
class HouseView {
  ...
  async addHouseSubmitHandler(e) {
    ...
    try {
      await _BunkyAPI.default.addHouse(formData);

      _Toast.default.show('House Added!');

      submitBtn.removeAttribute('loading'); //reset-----
      //text and textarea

      const textInputs = document.querySelectorAll('sl-input, sl-textarea');
      if (textInputs) textInputs.forEach(textInputs => textInputs.value = null); //radio button

      const radioInputs = document.querySelectorAll('sl-radio');
      if (radioInputs) radioInputs.forEach(radioInputs => radioInputs.removeAttribute('checked')); //image
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.addHouseSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new HouseView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../BunkyAPI":"BunkyAPI.js","../../Toast":"Toast.js"}],"views/pages/bunky.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"House Owner\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\"> \n      \n      <div class=\"filter-menu\">\n        <div>\n          filter by\n        </div>\n        <div>\n          <strong>Period</strong>\n          <sl-button class=\"filter-btn\" size=\"small\" data-field= \"period\" data-match= \"s\" @click=", ">Short</sl-button>\n          <sl-button class=\"filter-btn\" size=\"small\" data-field= \"period\" data-match= \"l\" @click=", ">Long</sl-button>\n          \n        </div>\n        <div>\n        <strong>Price</strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field= \"price\" data-match= \"5000-6000\" @click=", ">Rs5000-6000</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field= \"price\" data-match= \"7000-10000\" @click=", ">Rs7000-10000</sl-button>\n        \n      </div>\n        <div>\n          <sl-button size=\"small\" @click=", ">Clear Filters</sl-button>\n        </div>\n\n      </div>\n       \n        <div class=\"bunky-grid\">\n        ", "\n        </div>\n      </div>      \n    "]);
...
class bunkyView {
  ...
  async filterbunky(field, match) {
    // validate
    if (!field || !match) return; // get fresh copy of bunky

    this.Bunky = await _BunkyAPI.default.getBunky();
    let filteredBunkey; //period
  ...
  handleFilterBtn(e) {
    // clear active btn
    this.clearFilterBtns(); // set active

    e.target.setAttribute("type", "primary");
    const field = e.target.getAttribute("data-field");
    const match = e.target.getAttribute("data-match"); //filter bunky
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearfilters.bind(this), this.Bunky == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.Bunky.map(Bunky => (0, _litHtml.html)(_templateObject4(), Bunky.name, Bunky.description, Bunky.price, JSON.stringify(Bunky.user), Bunky.image, Bunky.location, Bunky.period))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new bunkyView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../BunkyAPI":"BunkyAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _addHouse = _interopRequireDefault(require("./views/pages/addHouse"));

var _bunky = _interopRequireDefault(require("./views/pages/bunky"));
...
const routes = {
  ...
  '/bunky': _bunky.default,
  '/addHouse': _addHouse.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/addHouse":"views/pages/addHouse.js","./views/pages/bunky":"views/pages/bunky.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject5() {
  const data = _taggedTemplateLiteral(["\n      <a href=\"/addHouse\" @click=\"", "\">Add House</a>\n      "]);
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, this.user.accessLevel == 1 ? (0, _litElement.html)(_templateObject3(), _Router.anchorRoute) : (0, _litElement.html)(_templateObject4()), e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.user.accessLevel == 1 ? (0, _litElement.html)(_templateObject5(), this.menuClick) : (0, _litElement.html)(_templateObject6()), this.menuClick, () => _Auth.default.signOut());
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-bunky.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-bunky', class Bunky extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  moreInfoHandler() {
    ...
    dialogEl.className = 'bunky-dialog'; // sl-dialog content

    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.name, this.name, this.description, this.price, this.location, this.period);
    render(dialogContent, dialogEl); // append to document.body

    document.body.append(dialogEl); //show sl-dialog

    dialogEl.show(); // delete dialog
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.name, this.description, this.price, this.user.firstName, this.user.lastName, this.moreInfoHandler);
  }
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-bunky":"components/va-bunky.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
